        ...
        for ($row = 2;$row <= $highestRow;$row++) 
        {
			...
			if ($result){
				...
				foreach($subjects as $subject)
				{
					...
					$xk_query.=" smallint, ";
					$DB->query("create table sem".$id."_sj".$subject['subject']."_exam ( exam char(20) NOT NULL, exam_name char(40), sj_num smallint NOT NULL, class_num smallint NOT NULL, publisher int NOT NULL, maxgrade smallint NOT NULL, begintime timestamp NOT NULL, endtime timestamp NOT NULL, PRIMARY KEY(exam));");
