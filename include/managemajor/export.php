...
//设置表头 
$resultPHPExcel->getActiveSheet()->setCellValue('A1', '专业ID'); 
$resultPHPExcel->getActiveSheet()->setCellValue('B1', '专业名称'); 
//设置列宽度
...
//读取数据库，生成Excel表格
$i = 2; 
$items= $DB->get_all("select * from major");
foreach($items as $k=>$v){ 
	$resultPHPExcel->getActiveSheet()->setCellValue('A' . $i, $v['major']);
	$resultPHPExcel->getActiveSheet()->setCellValue('B' . $i, $v['major_name']); 
	$i++; 
}
//设置导出文件名 
