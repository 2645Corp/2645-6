  ...
  <div class="container">
    ...
    <div class="navbar-collapse collapse">
      <ul class="nav navbar-nav navbar-left" id="menu">
        <li><a class="hvr-underline-from-left" data-scroll data-options="easing: easeOutQuart" href="http://www.whyzsyb.com">主頁</a></li>
        <li><a class="hvr-underline-from-left" data-scroll data-options="easing: easeOutQuart" href="#">關於</a></li>
      </ul>
      <ul class="nav navbar-nav navbar-right" id="menu">
        <li><a class="hvr-underline-from-left" data-scroll data-options="easing: easeOutQuart" href="reg/">註冊</a></li>
        <li role="presentation" class="dropdown"> <a href="#" data-scroll data-options="easing: easeOutQuart" data-toggle="dropdown" class="dropdown-toggle hvr-underline-from-left">選擇語言<b class="caret"></b></a>
  ...
  <div class="row loginpanel col-xs-9 col-xs-offset-1 col-sm-6 col-sm-offset-3 col-md-6 col-md-offset-6 col-lg-offset-7">
    <form method="post" action="include/check_login.php" class="form-horizontal">
      <div class="col-xs-12"> <br/>
        <input class="form-control" name="username" id="username" required="true" placeholder="使用者名稱" />
        <br/>
        <input class="form-control" type="password" name="pass" id="pass" required="true"  placeholder="密碼"/>
        <br/>
        <!--<input class="btn btn-default" type="button" id="Button2" value="注册" onclick="window.location.href='reg'"/>-->
        <input class="btn btn-primary" type="submit" id="Button1" style="width:100%; margin-bottom:10px;" value="登入" />
        <a href="reg/findmypass.html">忘記了密碼？</a> </div>
    </form>
  </div>
</div>
<section id="slider">
  <div class="slider-grid">
    ...
    <div class="col-md-12 col-sm-12 item"> <img src="assets/images/slider/slider-img-1.jpg" alt="gallery">
      <div class="text left">
        <h2 class="wow fadeInRight" data-wow-duration="1s" data-wow-delay="1s">歡迎使用<strong>威海一中實驗部</strong> <span>教學管理平臺</span></h2>
      </div>
    </div>
...
<footer>
  <div class="container">
    <ul class="list-inline social">
      ...
      <li class="wow bounceIn" data-wow-duration="0.6s" data-wow-delay="0.6s"><a href="https://github.com/2645Corp/2645-6" target="_blank" title="獲取源代碼"><img src="assets/images/social-icons/github.png" alt="github"></a></li>
      <li class="wow bounceIn" data-wow-duration="0.7s" data-wow-delay="0.7s"><a href="http://www.whyizhong.net" target="_blank" title="威海市第一中學"><img src="assets/images/social-icons/yizhong.png" alt="威海一中"></a></li>
      <li class="wow bounceIn" data-wow-duration="0.8s" data-wow-delay="0.8s"><a href="http://linux.cool2645.com/2645-6" target="_blank" title="2645-6實驗站"><img src="assets/images/social-icons/typhoon.png" alt="Experimental site"></a></li>
  ...
  <div class="foot-line">
    <p>&copy; 2016 2645工作室. 本頁面由<a href="#"><strong><a href="http://www.flashline.cn/" target="_blank">CreativeMonkie</a></strong></a>參與設計. <a href="http://www.miitbeian.gov.cn">鲁ICP备16005737号-2</a></p>
  </div>
</footer>
